			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids">
						...
						<ul>
							<li class="mb-3">
								<a  href="?quanly=danhmuc&id=<?php echo $row_danhmuc['category_id']; ?>" role="button" aria-haspopup="true" aria-expanded="false">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-sm-0 mt-4">
						...
						<ul>
								...
								?>
							<li class="mb-3">
								<a href="?quanly=tintuc&id_tin=<?php echo $row_danhmuctin['danhmuctin_id']; ?>">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						<h3 class="text-white font-weight-bold mb-3">Địa chỉ</h3>
						<ul>
							<li class="mb-3">
					...
					<div class="col-md-3 col-sm-6 footer-grids w3l-agileits mt-md-0 mt-4">
						...
						<p class="mb-3">Nhập địa chỉ email</p>
