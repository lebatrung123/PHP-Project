<?php
	...
	$sql_cate = mysqli_query($conn, "SELECT * FROM tbl_category,tbl_product WHERE 
	tbl_category.category_id = tbl_product.category_id AND tbl_product.category_id = '$id'
	ORDER BY tbl_product.category_id DESC");

	$sql_category = mysqli_query($conn, "SELECT * FROM tbl_category,tbl_product WHERE 
	tbl_category.category_id = tbl_product.category_id AND tbl_product.category_id = '$id'
	ORDER BY tbl_product.category_id DESC");
									...
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price"><?php echo number_format($row_product['product_giakhuyenmai']).'vnđ'; ?></span> <br>
